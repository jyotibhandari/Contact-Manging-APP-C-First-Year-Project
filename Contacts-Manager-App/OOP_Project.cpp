...
{
	Contact object;
	cout<<"\n\t\t\t\t\t**** Welcome to Contacts Manager Application :\n\n------- Bulid by Jyoti Bhandari /2078Batch -1st year Project ,Himalaya College --------- ****"<<endl;
	cout<<"\n\n INSTRUCTION: YOU CAN ONLY VIEW/SEARCH FOR A CONTACT IF YOU ARE A USER. TO EDIT, DELETE AN EXISTING CONTACT OR ADD ANY NEW CONTACT, SIGN IN AS ADMINISTRATOR."<<endl;
block:
